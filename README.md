...
The plugin registers /instances/(.*)/extract-document call which will give the single file from ZIP container (i.e. report in whatever format is stored inside: LibreOffice odt, Microsoft Word docx, TextEdit rtf, Pages .pages or .html generated by Osirix web reporting tool). 
